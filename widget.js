...
let fontStyle, color
const imageBasePath = 'https://billionbrix-awsum.s3.us-east-2.amazonaws.com/Jsfile/widgetimages/'
const onImgClick = () => {
...
const onEstimateClick = (e) => {
    ...
    estimateh5.classList.add('estimate-h5')
...
const onEscrowOfficeClick = (e) => {
    ...
    escrowofficeh5.classList.add('escrow-office-h5')
...
const getImageMap = (productName, estimateImg) => {
    ...
    switch (productName) {
        ...
        case 'Cita del título':
            img = 'titlequotecalculator.png'
            break
        case 'Buyer\'s Estimate':
        case 'Estimación del comprador':
            img = 'Buyerestimate.png'
            break
        case 'Seller\'s Netsheet':
        case 'Hoja de red del vendedor':
            img = 'sellernetsheet.png'
            break
        case 'Lender\'s Calculator':
        case 'Calculadora del prestamista':
            img = 'lenderestimate.png'
            break
        case 'Closing Disclosure':
        case 'Divulgación de cierre':
            img = 'closingdiscloser.png'
            break
    }

    estimateImg.src = imageBasePath + img
}
const infoEs = ['Información sobre su título y oficina de depósito en garantía', 'Estimar su costo de cierre, ganancias netas, refinanciar costo u obtener una cotización de título',
    'información que necesita para un cierre sin problemas']


const info = ['Information regarding your title and escrow office', 'Estimate your closing cost, net proceeds, refinance cost or get a title quote',
...
const context = {
    ...
    'estimate_quote': 'Estimate your closing cost, net proceeds, refinance cost or get a title quote',
    'estimate_quote_es': 'Estimar su costo de cierre, ganancias netas, refinanciar costo u obtener una cotización de título',
...
(function () {
    ...
    widgetAvatar.setAttribute('src', imageBasePath + 'avatarwidget.png');
    ...
    backImage.setAttribute('src', imageBasePath + 'back.png');
    ...
    headervatarImage.setAttribute('src', imageBasePath + 'avatarwidget.png');
    ...
    widgetInfoImage1.setAttribute('src', imageBasePath + 'hi.png');
    ...
    widgetInfoImage2.setAttribute('src', imageBasePath + 'hola.png');
    ...
    const optionImage = ['officeinformation.png', 'provideestimationoftitlequoteselletnetsheetetc.png', 'informationforsmoothclosing.png']
    optionImage.forEach((img, index) => {
        var widgetInfoOptions = document.createElement("div");
        widgetInfoOptions.classList.add('list-info-outer-instruct-div');
        var widgetInfoOptionsImg = document.createElement("img");
        widgetInfoOptionsImg.setAttribute('src', imageBasePath + img);
